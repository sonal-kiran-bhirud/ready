...
$sql = "SELECT * FROM `blooddonation` WHERE id = '$id'";
                      ...
                      <hr style="color: purple;">
                        ...
                        <div class="row">
                          ...
                          <option value="Select Blood Group">Select Blood Group</option>
                            <option value="A+ve"<?php if($row['blood']== 'A+ve'){ echo 'selected';}?>>O+ve</option>
                            <option value="A-ve"<?php if($row['blood']== 'A-ve'){ echo 'selected';}?>>O-ve</option>
                            <option value="B+ve"<?php if($row['blood']== 'B+ve'){ echo 'selected';}?>>B+ve</option>
                            <option value="B-ve"<?php if($row['blood']== 'B-ve'){ echo 'selected';}?>>B-ve</option>
                            <option value="O+ve"<?php if($row['blood']== 'O+ve'){ echo 'selected';}?>>AB+ve</option>
                            <option value="O-ve"<?php if($row['blood']== 'O-ve'){ echo 'selected';}?>>AB-ve</option>
                            <option value="AB+ve"<?php if($row['blood']== 'AB+ve'){ echo 'selected';}?>>A+ve</option>
                            <option value="AB-ve"<?php if($row['blood']== 'AB-ve'){ echo 'selected';}?>>A-ve</option>
                          </select>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <input type="date" name="dateofbirth" class="form-control" value="<?php echo $row['dateofbirth'];?>">
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <label for="prevdonation">Have you Donate previously?</label>
                              ...
                              <input type="radio" value="Yes" <?php echo ($row['prevdonation']== 'Yes') ? "checked" : "" ; ?> name="prevdonation" id="prevdonation" height="18px">
                              
                              
                              <input type="radio" value="No" <?php echo ($row['prevdonation']== 'No') ? "checked" : "" ; ?> name="prevdonation" id="prevdonation">
                              
                              </div>
                          </div>
                          <div class="col-md-6">

                          <label for="prevdonationmonth">

                          <input type="text" name="prevdonationmonth"<?php echo $row['prevdonationmonth'];?> >
