...
if(isset($_POST['submit'])){
    ...
    $insuranceexp = $_POST['insuranceexp'];
    $insuranceholder = $_POST['insuranceholder'];
    ...
    $relation = $_POST['relation'];
      ...
      $sql = "INSERT INTO `patients`(  `name`,`patient`, `aadharno`, `address`,, `contact` `gender`,`blood`, `age`, `email`, `dateofbirth`,`height`,`weight`,`indate`, `outdate`, `doctor`,`nurse`, `roomno`, `companyname`, `insuranceid`, `insuranceexp`, `insuranceholder`, `emergencycontact`,`medicalhistory`, `occupation`,`relation`) VALUES ('$name', '$patient', '$aadharno', '$address', '$contact', '$gender', '$blood', '$age', '$email', '$dateofbirth', '$height', '$weight' , '$indate', '$outdate', '$doctor', '$nurse', '$roomno', '$companyname', '$insuranceid', '$insuranceexp', '$insuranceholder', '$emergencycontact', '$medicalhistory', '$occupation', '$relation')";
