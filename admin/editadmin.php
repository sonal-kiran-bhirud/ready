    ...
    <header>
       ...
       <div class="row">
        ...
        <!--<input type="radio" name="gender" value="other"> Other-->
            ...
            <input type="file" class="form-control-file" name="old_file" id="old_file" placeholder="">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="registrationdate" value="<?php echo $row['registrationdate'];?>" >
