        ...
        <div class="row">
            <div class="col-sm-2 " style="outline: 2px solid gray;">
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                 ...
                 <a href="../patientregform.php" class="text-decoration-none btn" style="width:100%;padding-left:7px;"><i class="fa-solid fa-user-nurse"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Patient</a>
                </div><br>
                ...
                <div id="imgp" style="padding-left:60px;padding-top:150px;" class="d-grid gap-2 col-3 mx-auto">
                  ...
                  <div class="row">
                    <div class="col-sm-2" id="registration">
                        <h5><i class="fa-solid fa-user-plus" style="color:purple;"></i>&nbsp;Patient</h5>
                    ...
                    <div class="col-sm-3" id="registration">
                        <h5><i class="fa-solid fa-bed-pulse"style="color:purple;"></i>&nbsp;Admit patient</h5>
                    </div>
                    <div class="col-sm-3" id="registration">
                        <h5><i class="fa-solid fa-user-plus" style="color:red;"></i>&nbsp;Discharge Patient <br>
                      (Today)</h5>
                    </div>
                </div>
            ...
            <div class="col-sm-2 " style="outline: 2px solid gray;">
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                   ...
                   <ul class="dropdown-menu">
                     ...
                     <li><hr></li>
                        <li><a class="dropdown-item" href="ipd.php">IPD Registration</a></li>
                        <li><a class="dropdown-item" href="OPD.php">OPD Registration</a></li>
                        <li><a class="dropdown-item" href="emergencyr.php">Emergency Registration</a></li>
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                   ...
                   <ul class="dropdown-menu">
                     ...
                     <li><a class="dropdown-item" href="BloodDonationform.php">Donar Registration</a></li>
                 </ul>
                </div><br>
                ...
                <nav class="navbar navbar-expand-lg bg-body-tertiary" >
                    <div class="container-fluid" style="background-color:purple">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          <li class="nav-item" >
                            <a class="nav-link active" aria-current="page" href="../receptionist/receptionistdashboard.php" style="color: aliceblue;">Home</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#" style="color: aliceblue;"></a>
                          </li>
