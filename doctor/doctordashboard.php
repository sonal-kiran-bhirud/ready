    ...
    <div class="fluid-container">
        <div class="row">
            <div class="col-sm-2 " style="outline: 2px solid gray;">
                ...
                <hr style="margin: 7px; ">
                <div><img src="../uploads/<?php echo $row['myfile']; ?>" alt="image" height="80px" width="80px" style="border-radius: 50%;margin-left: 9px;">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size: 20px; font-weight: bold;"><?php echo $row['name'] ?></font></div>
                    ...
                    <div class="container-fluid" style="background-color:purple">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          <li class="nav-item" >
                            <a class="nav-link active home" aria-current="page" href="" onclick()="history.back();" return false; style="color: aliceblue;">back</a>
                          </li>
                          <li class="nav-item">
