...
$sql="SELECT * FROM `register` WHERE `profession`='doctor'";
                        ...
                        <table class="table table-bordered table-dark table-striped table-hover" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><a href="profile.php?id=<?php echo $row['id']; ?>" style="text-align: center;">View</a></td>
                                    <td><a href="doctoredit.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil" style="font-size:20px; color:black;"></i></a>&nbsp;
                                    <a href="doctordelete.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" style="font-size:20px; color:red;"></i></a></td>
                                </tr>
                            </tbody>
                            <?php } ?>
