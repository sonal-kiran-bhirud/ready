<?php
       ...
       // $id = $_SESSION['id'];
        ...
        $sql = "SELECT `id`, `name`, `email`, `aadharno`, `gender`, `contact`, `qualification`, `myfile` FROM `receptionist`;";
...
<div class="fluid-container">
    <div class="row">
     ...
     <div class="col-lg-4">
            <div class="" style="">
                <div class="">
                    <h5  id="font1">Receptioninist List
                    </h5>
             </div>
         </div>
     </div>
     ...
     <div class="col-lg-4">
            <div class="" style="">
                ...
                <div class="input-group mb-3" width=10% style="margin-left:0%;margin-top:15px">
                       <input type="text" class="form-control" placeholder="Search" aria-label="Recipient's username" aria-describedby="button-addon2" style="margin-left:30%" name="search" id="search" onkeyup="searchfun()">
...
<td><?php echo $cn++; ?></td>
    ...
    <td><a href="editreceptionist.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil" style="font-size:30px;color:black;"></i> </a>
    <a href="deletereceptionist.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash " style="font-size:30px;color:red;"></i></a></td>
