...
//from here all files are remaining not changed.
include('../connection.php');
//Overall donar count
$query="SELECT COUNT(*) AS total FROM blooddonation";
$res= mysqli_query($conn, $query);
$row= mysqli_fetch_assoc($res);
$count= $row['total'];
//today donar count
$queryd="SELECT COUNT(*) AS dtotal FROM bloodonation Where DATE(date) = CURDATE()";
...
//A+ve
$query1="SELECT SUM(Dblood_ml) AS total1 FROM bloodonation WHERE Blood='A+ve'";
...
//A-ve
$query2 = "SELECT SUM(Dblood_ml) AS total2 FROM bloodonation WHERE Blood='A-ve'";
...
//B+ve
$query3="SELECT SUM(Dblood_ml) AS total3 FROM blooddonation WHERE Blood='B+ve'";
...
//B-ve
$query4="SELECT SUM(Dblood_ml) AS total4 FROM blooddonation WHERE Blood='B-ve'";
...
//O+ve
$query5 = "SELECT SUM(Dblood_ml) AS total5 FROM blooddonation WHERE Blood='O+ve'";
...
//O-ve
$query6 = "SELECT SUM(Dblood_ml) AS total6 FROM blooddonation WHERE Blood='O-ve'";
...
//AB+ve
$query7 = "SELECT SUM(Dblood_ml) AS total7 FROM blooddonation WHERE Blood='AB+ve'";
...
//AB-ve
$query8="SELECT SUM(Dblood_ml) AS total8 FROM blooddonation WHERE Blood='AB-ve'";
    ...
    <div class="fluid-container">
        ...
        <div class="col-sm-2 " style="outline: 2px solid gray;">
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                 ...
                 <a href="doctorlistofrcpn.php" class="text-decoration-none btn" style="width:100%;padding-left:7px;"><i class="fa-solid fa-user-doctor"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Doctor</a>
                </div><br>
                <div class="dropdown" style="width:100%;margin-left:7px">
                 ...
                 <a href="nurselistofrcpn.php" class="text-decoration-none btn" style="width:100%;padding-left:7px;"><i class="fa-solid fa-user-nurse"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nurse</a>
                </div><br>
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                 ...
                 <a href="patientsofrcpn.php" class="text-decoration-none btn" style="width:100%;padding-left:7px;"><i class="fa-solid fa-user-nurse"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Patient</a>
                </div><br>
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                 ...
                 <a href="bloodbankofrcpn.php" class="text-decoration-none btn" style="width:100%;padding-left:7px;"><i class="fa-solid fa-droplet"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Blood Bank</a>
                </div><br>
