        ...
        <div class="row">
            ...
            <div class="col-sm-10" >
              ...
              <div class="row table-responsive">
                      <h2><i class="fa-solid fa-user-doctor mt-4" style="color:purple"></i>&nbsp;&nbsp;Doctor List -</h2>
                      <hr>
                        <table class="table table-bordered" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><a href="dpatient.php?id=<?php echo $row['id']; ?>"><i class="fa-regular fa-eye"></i></a></td>
                                    <td><a href="../doctor/profile.php?id=<?php echo $row['id']; ?>" style="text-align: center;">View</a></td>
                                </tr>
                            </tbody>
                            <?php } ?>
